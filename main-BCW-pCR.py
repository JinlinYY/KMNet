...
from component.Fusion import combine_features, combine_features_concat_2
...
def main():
    ...
    # 提取原始表格特征
    index, excel_feature, label = extract_excel_features('/tmp/pycharm_project_357/BCW/BCW-data.xlsx')
    ...
    # 表格特征构图，GNN提取图表格特征
    _, gnn_excel_feature, _ = gnn_extract_excel_features('/tmp/pycharm_project_357/BCW/BCW-data.xlsx')
    ...
    combined_features = combine_features_concat_2(excel_feature_pca_tensor, gnn_excel_feature_pca_tensor)  # 两模态
