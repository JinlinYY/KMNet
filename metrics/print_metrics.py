...
# def print_average_metrics(accuracy_scores, precision_scores, recall_scores, f1_scores, AUC_score_macro, AUC_score_micro):
...
def print_average_metrics_BCa(accuracy_scores, precision_scores, recall_scores, f1_scores, AUC,specificitiy_scores, FNR_scores):
    print(f'\nAverage metrics across {len(accuracy_scores)} folds:')
    print(f'Accuracy: {np.mean(accuracy_scores):.4f} ± {np.std(accuracy_scores):.4f}')
    print(f'Precision: {np.mean(precision_scores):.4f} ± {np.std(precision_scores):.4f}')
    print(f'Recall: {np.mean(recall_scores):.4f} ± {np.std(recall_scores):.4f}')
